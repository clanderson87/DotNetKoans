...
namespace DotNetKoans.CSharp
{
    public class AboutNil : Koan
    {
        ...
        public void AWayNotToCheckThatAnObjectIsNull()
        {
            ...
            //Or, Assert.Equal(obj, null);

            //line 52 fails because 'null is not an object', 
            //therefore null doesn have the property of '.Equals' like an object does.
            //null still takes up memory
        }
    }
}
